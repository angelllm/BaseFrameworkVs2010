...
<div id="snow"></div>
<svg id="svg1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px" width="453px" height="378.5px" viewBox="0 0 463 378.5" style="enable-background:new 0 0 463 378.5;"
xml:space="preserve">
    ...
    <g id="santa_2_">
        ...
        <g class="face">
            ...
            <g id="nose-mustache_1_">
                <path class="st10" d="M290.5,134.6c0,0-13.1-4.7-25.8,11.8s-24.8,20.3-24.8,20.3s35.2,18.2,56-13c0,0,29.3,17.2,53.8-6             c0,0-13-13-26.3-16.3C310.1,128.1,299.2,126.4,290.5,134.6z" />
            ...
            <path id="brow-right_1_" class="st10" d="M299.6,101.1c0,0,12.2-8.7,22.7-6.4c0,0,8.4,3.8-1.3,8.2c0,0-10.2-3.3-20.3,6.6  C300.6,109.5,288.8,108.9,299.6,101.1z" />
            <path id="brow-left_1_" class="st10" d="M247.6,114.1c0,0,12.2-8.7,22.7-6.4c0,0,8.4,3.8-1.3,8.2c0,0-10.2-3.3-20.3,6.6 C248.6,122.5,236.8,121.9,247.6,114.1z" />
        </g>
    </g>
</svg>

<svg id="svg2" version="1.1" class="snowbg" x="0px" y="0px" width="704px" height="153.1px" viewBox="0 0 704 153.1" style="enable-background:new 0 0 704 153.1;">
...
#snow {
    ...
    background-image: url("https://s3-us-west-2.amazonaws.com/s.cdpn.io/49306/snow_copy.png"), url("http://www.wearewebstars.dk/codepen/img//s2.png"), url("http://www.wearewebstars.dk/codepen/img//s3.png");
    height: 100%;
    left: 0;
    position: absolute;
    top: 0;
