...
define("avalon", function (require, exports, module) {
    /*==================================================
     ...
     avalon.shim.js(无加载器版本) 1.46 built in 2015.8.12
    ...
    (function (global, factory) {
        ...
        var filters = avalon.filters = {
            ...
            totag: function (str, char, tag,href, clas, c) {
                var _outhtml = ""
                var _spilt = str.split(char)
                for (var i = 0; i < _spilt.length; i++) {
                    _outhtml += "<" + tag + " class='" + clas + "' href='" + href + "' >" + _spilt[i] + c + "</" + tag + ">";
                }
                return _outhtml
            },
