    ...
    $.fn.extend({
        ...
        AeroWindow: function (options) {
            ...
            return this.each(function () {
                var o = options;
                //add footerbar
                $("#tool-bar").append('<div for="' + WindowID + '" class="taskbar ' + WindowID + '"><img src="' + o.WindowIcon + '"><label onselectstart="return false">' + o.WindowTitle + '</label><div class="clear"></div></div>');
                var footerWindowID = $("." + WindowID);
                //reg window at footer postion left
                o.WindowFooterBarLeft = footerWindowID.offset().left;
                ...
                if (o.WindowMinimize) {
                    if (o.WindowMaximize || o.WindowClosable) {
                        var WinMinBtn = '<a class="win-min-btn"></a><div class="win-btn-spacer"></div>';
                    } else {
                        var WinMinBtn = '<a  class="win-min-btn"></a>';
                    }
                } else {
                    var WinMinBtn = '';
                }
                ...
                if (o.WindowMaximize) {
                    if (o.WindowClosable) {
                        var WinMaxBtn = '<div class="WinBtnSet winmax"><a class="win-max-btn"></a><div class="win-btn-spacer"></div></div>';
                        var WinRegBtn = '<div class="WinBtnSet winreg"><a class="win-reg-btn"></a><div class="win-btn-spacer"></div></div>';
                    } else {
                        var WinMaxBtn = '<div class="WinBtnSet winmax"><a class="win-max-btn"></a></div>';
                        var WinRegBtn = '<div class="WinBtnSet winreg"><a class="win-reg-btn"></a></div>';
                    }
                } else {
                    var WinMaxBtn = '';
                    var WinRegBtn = '';
                ...
                //BTN ---
                if (o.WindowClosable) {
                    var WinCloseBtn = '<a class="win-close-btn"></a>';
                } else {
                    var WinCloseBtn = '';
                }
                ...
                $(this).html(
                          ...
                          '        <div class="title header-title" onselectstart="return false"><nobr>' + o.WindowTitle + '</nobr></div>' +
                          '        <div class="buttons">' +
                                     WinBtnLeftedge +
                                     WinMinBtn +
                                     WinMaxBtn +
                ...
                //Set Window Position
                var _length = $(".active").length;
                if (_length > 0) {
                    //console.log($(".active").find(".table-mm-container").css("visibility"));
                    //break new window to be hidden
                    if ($(".active").find(".table-mm-container").css("visibility") != "hidden") {
                    o.WindowPositionLeft = $(".active").offset().left + 20;
                    o.WindowPositionTop = $(".active").offset().top + 20;
                }
                ...
                console.log("Initial WindowStatus:" + o.WindowStatus);
                ...
                if (o.WindowMaximize) {
                    $(this).find(".header-title").dblclick(function () {
                        switch (o.WindowStatus) {
                            case 'regular':
                                MaximizeWindow();
                                break;
                ...
                BTNClose.click(function () {
                    ...
                    $("." + o.WindowIDTAG).css('display', 'none');
                ...
                $("." + WindowID).click(function () {
                    //Window = $("." + WindowID).find(".AeroWindow");
                    console.log("o.WindowStatus:" + o.WindowStatus);
                    switch (o.WindowStatus) {
                        case 'regular':
                            MinimizeWindow();
                            o.WindowStatus = 'minimized';
                        ...
                        case 'minimized':
                            ...
                            o.WindowStatus = 'regular';
                            break;
                        default: RegularWindow(); o.WindowStatus = 'regular';
                            break;
                ...
                $("#show-desk").click(function () {
                    ...
                    $(".Window").each(function (index, item) {
                        ...
                        if (!flag) {
                            ...
                            if ($(item).find(".table-mm-container").css("visibility") == "visible") {
                                flag = true;
                            }
                        }
