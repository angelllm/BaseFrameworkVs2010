...
$.confirm2 = $.dialog.confirm2 = function (content, ok, cancel) {
    return $.dialog({
        id: 'Confirm',
        title:"\u786e\u8ba4\u63d0\u793a",
        fixed: false,
...
$.confirm3 = $.dialog.confirm3 = function (content, ok, cancel) {
    return $.dialog({
        id: 'Confirm',
        title:"\u786e\u8ba4\u63d0\u793a",
        fixed: true,
...
$.confirmSmiple = $.dialog.confirmSmiple = function (content, ok, cancel) {
    return $.dialog({
        id: 'Confirm',
        title:"\u786e\u8ba4\u63d0\u793a",
        fixed: true,
...
var dragInit = function (event) {
    ...
    var isResize = event.target === dom.res[0] ? true : false ;
...
$(document).bind('mousedown', function (event) {
    ...
    if (config.resize !== "False" && target === dom.res[0]) {
        dragInit(event);
        // 防止firefox与chrome滚屏
        //return false; //return 后改变窗口大小时候补连贯不流畅
    };
});
