...
artDialog.fn = artDialog.prototype = {
    ...
    */
    ...
    animate_size: function (width, height) {
        ...
        jQuery(style).animate({width:width,height:height});
        //style.width = width;
        //style.height = height;
    ...
    */
    ...
    max: function () {  
     ...
     if (this.config.maxed) {
            ...
            return this.size(_w,_h ).orgin(_x,_y);
...
+                                       '<a class="d-min" href="javascript:;" title="{minValue}">-</a>'
+                                       '<a class="d-max" href="javascript:;" title="{maxlValue}">+</a>'
