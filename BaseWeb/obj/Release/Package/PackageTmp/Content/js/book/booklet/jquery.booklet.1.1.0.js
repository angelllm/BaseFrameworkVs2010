...
; (function ($) {
    ...
    $.fn.booklet = function (options) {
        ...
        return $(this).each(function () {
            ...
            //else build new booklet
                ...
                obj = new booklet($(this), config, id,o.empty_valye,o.blank_value,o.last_value);
    ...
    _loading=0;
    function booklet(target, options, id,empty_value,blank_value,last_value) {
        ...
        end_empty ='<div class="b-page-empty" title="" rel="">'+last_value+'</div>'
		empty = '<div class="b-page-empty" title="" rel="">'+empty_value+'</div>', blank = '<div class="b-page-blank" title="" rel="">'+blank_value+'</div>'
	;
        ...
        $.extend(self,
	{
	    next: function () {
	        if (!busy) {
                ...
                _loading = opts.curr + 1; //console.log(_loading);
	        }
	    },
	    prev: function () {
	        if (!busy) {
	            self.gotoPage(opts.curr - 2);
                _loading = opts.curr ; //console.log(_loading);
	        }
	    },
        ...
        //add tabs
        if (opts.tabs) {
            tabP = $('<div class="b-tab b-tab-prev b-prev" title="上一页">Previous</div>').appendTo(b);
            tabN = $('<div class="b-tab b-tab-next b-next" title="下一页">Next</div>').appendTo(b);
            tabs = b.find('.b-tab');
