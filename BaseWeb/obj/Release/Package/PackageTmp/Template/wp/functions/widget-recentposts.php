...
class AdvancedRecentPosts extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => __('The most recent posts on your site. Includes advanced options.', 'mythemeshop')
        );
...
$image_url = wp_get_attachment_image_src($image_id,'widgetbigthumb');
$image_url = $image_url[0];
					if(has_post_thumbnail()) {
						$POST_THUMBNAIL = "<a href=\"".get_permalink($ID)."\" title=\"".get_the_title($ID)."\" ><img src=\"".$image_url."\" class=\"wp-post-image\"></a>";
					} else {
						$POST_THUMBNAIL = "<a href=\"".get_permalink($ID)."\" title=\"".get_the_title($ID)."\" ><img src=\"".bloginfo('template_directory')."/images/smallthumb.png\" class=\"wp-post-image\"></a>";
					}
