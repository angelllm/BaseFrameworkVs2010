<template>
     <div :class="{posts:true ,fadeInDown:true , animated:true,show:isShow }">
        <article class="post type-post status-publish format-aside has-post-thumbnail sticky hentry category-wordpress tag-teahouse tag-wordpress post_format-post-format-aside">
                <div class="box-wrap">
                  <div class="box">
                      <header>
                        <h2 class="entry-title"><router-link class="pjax simptip-smooth simptip-movable simptip-position-right" to="/about/">关于我</router-link></h2>
                      </header>   
                                ...
                                <div class="experience">
                                  <h2 class="white">Experiences</h2>
                                    <div class="experience-content">
                                      <p><h5 class="experiences-time">2008.8 - 2011.7 </h5><h5 class="experiences-company">常熟诚展网络科技有限公司</h5><span>.net程序员</span></p>
                                      <p><h5 class="experiences-time">2011.11 - 2013.8 </h5><h5 class="experiences-company">苏州舟游网络科技有限公司</h5><span>.net程序员</span></p>
                                      <p><h5 class="experiences-time">2012.9 - 2014.7 </h5><h5 class="experiences-company">苏州橙果网络科技有限公司</h5><span>.net程序员</span></p>
                                      <p><h5 class="experiences-time">2014.8 - 2015.7 </h5><h5 class="experiences-company">常熟网店之家科技有限科技有限公司</h5><span>前端工程师</span></p>
                                      <p><h5 class="experiences-time">2015.8 - 至今 </h5><h5 class="experiences-company">苏州华车网络科技有限公司</h5><span>前端工程师</span></p>
                                    </div>
                                </div>
                              </div>
                            </div>
...
export default {
  ...
  mounted: function() {
      ...
      document.title  = "关于我" + "-" + this.base.page_title
  },
  created: function() {
...
<style>
@import '/assets/themes/templatemo-blue.css';
